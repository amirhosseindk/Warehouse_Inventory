...
namespace Persistence.Migrations
{
    ...
    [Migration("20230507165227_somanychanges")]
    partial class somanychanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ConsumerInvoice", b =>
                {
                    b.Property<Guid>("ConsumerInvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("RequisitiontDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("ConsumerInvoiceId");

                    b.HasIndex("WarehouseId");

                    b.ToTable("ConsumerInvoices");
                });
            ...
            modelBuilder.Entity("Domain.Entities.InsideTransferItemList", b =>
                {
                    b.Property<Guid>("InsideTransferItemListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("InsideTransferItemListId");

                    b.HasIndex("InsideTransferId");

                    b.ToTable("insideTransferItemLists");
                });
            ...
            modelBuilder.Entity("Domain.Entities.SupplierInvoice", b =>
                {
                    b.Property<Guid>("SupplierInvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.InsideTransferItemList", b =>
                {
                    b.HasOne("Domain.Entities.InsideTransfer", "InsideTransfer")
                        .WithMany("InsideTransferItems")
                        .HasForeignKey("InsideTransferId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("InsideTransfer");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ReceiptItemList", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.SupplierInvoice", null)
                        .WithMany("ReceiptItems")
            ...
            modelBuilder.Entity("Domain.Entities.RequisitionItemList", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ConsumerInvoice", null)
                        .WithMany("RequisitionItems")
                        .HasForeignKey("ConsumerInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Entities.InsideTransfer", b =>
                {
                    b.Navigation("InsideTransferItems");
                });
